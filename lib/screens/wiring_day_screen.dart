...
class WiringDayScreen extends ConsumerStatefulWidget {
  const WiringDayScreen({super.key});

  @override
  ConsumerState<WiringDayScreen> createState() => _WiringDayScreenState();
}

class _WiringDayScreenState extends ConsumerState<WiringDayScreen> {
  @override
  void initState() {
    super.initState();
